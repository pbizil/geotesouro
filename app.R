...
waiting_screen <- tagList(
  spin_3(),
  h4("GeoTesouro - Carregando a Plataforma...")
) 

# APP 

ui <- dashboardPage(preloader = list(html = waiting_screen, color = "grey"), title = "GeoTesouro",
  dark = NULL,  dashboardHeader(
    ...
    status = "secondary",
    rightUi = dropdownMenu( badgeStatus = "success",
                            icon = icon("github"),
                            type = "messages",
                            headerText = "oxy-data message",
                            messageItem(
                              "github/geotesouro",
                              ...
                              color = "secondary",
                              inputId = "message",
                              href = "https://github.com/pbizil/geotesouro"
                            ))),
